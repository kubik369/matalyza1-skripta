...
\begin{tabular}{|p{0.21\textwidth}|p{0.22\textwidth}|p{0.45\textwidth}|}
  ...
  \hline
\end{tabular}
\footnotetext[1]{symbol $\equiv$ čítame \enquote{identicky rovné}}
\footnotetext[2]{
  špeciálne v prípade $a=10$ budeme používať označenie $log_a x$, v prípade
  $a=e$ označenie $\ln x$
}
\footnotetext[3]{pozri odsek $1.3.4$}
